...
#define TSK_STACK_CANARY 1184 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2528 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 4176 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4072 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4152 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4168 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define TRAMP_VALIAS -10518528 /* TRAMP_VALIAS */
