...
deps_config := \
	...
	drivers/net/wireless/ti/cc33xx/Kconfig \
...
ifneq "$(KERNELVERSION)" "6.12.57"
$(autoconfig): FORCE
endif

ifneq "$(CC)" "/opt/arm-toolchain/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-gcc"
$(autoconfig): FORCE
endif

ifneq "$(LD)" "/opt/arm-toolchain/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-ld"
$(autoconfig): FORCE
endif
...
ifneq "$(CC_VERSION_TEXT)" "aarch64-none-linux-gnu-gcc (Arm GNU Toolchain 13.3.Rel1 (Build arm-13.24)) 13.3.1 20240614"
$(autoconfig): FORCE
endif

ifneq "$(NM)" "/opt/arm-toolchain/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-nm"
$(autoconfig): FORCE
endif

ifneq "$(OBJCOPY)" "/opt/arm-toolchain/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-objcopy"
$(autoconfig): FORCE
endif
...
ifneq "$(AR)" "/opt/arm-toolchain/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-ar"
$(autoconfig): FORCE
endif
